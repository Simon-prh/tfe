...
$data = file_get_contents('http://www.omdbapi.com/?t=D.O.A.&y=1950&plot=full&r=json');
		...
		<div class="container">
			...
			<header>	
					<video class="video_extrait format" preload="auto" autoplay loop > 
						<source src="videos/doa_extrait.mp4" type="video/mp4"> 
						<source src="videos/doa_extrait.ogv" type="video/ogg"> 
						<source src="videos/doa_extrait.webm" type="video/webm"> 
						Video not supported
					</video>
					<h1>This week <strong>#melancholy</strong><br>
						<span class="moviename">D . O . A .</span><br>
						<span class="productor">(by <strong>Leo C. Popkin</strong>, 1949)<span>
					</h1>
			...
			<main class="thisweek clearfix">
				<section class="synopsis">
					...
					<div class="info-wrapper clearfix">
						<p>Small-town accountant <strong>Frank Bigelow</strong> goes to San <strong>Francisco</strong> for a week's fun prior to settling down with <strong>fiancée Paula</strong>. After a night on the town, he wakes up with <strong>more than just a hangover</strong>; doctors tell him he's been given a <strong>"luminous toxin"</strong> with no antidote and has, at most, <strong>a week to live</strong>! </p><p>Not knowing who did it or why, Bigelow embarks on a <strong>frantic odyssey</strong> to find his own <strong>murderer</strong></p>

					<p><i>Considered a classic of the noir genre, this movie begins with a scene called one of cinema's most innovative opening sequences.</i></p>					
						<ul class="clearfix">
				...
				<section class="videoContainer">
						...
						<div class="video-wrapper">
					    	<video id="movies" class="movies" controls preload="auto" poster="img/poster.jpg">
					     	...
					     	<source src="https://ia700506.us.archive.org/11/items/doa_1949/doa_1949_512kb.mp4" type="video/mp4"> 
							<source src="https://ia700506.us.archive.org/11/items/doa_1949/doa_1949.ogv" type="video/ogg"> 						
							</video>
							<div class="loading">
