...
$data = file_get_contents('http://www.omdbapi.com/?t=Battleship+Potemkin&y=&plot=full&r=json');
		...
		<div class="container">
			...
			<header>	
					<video class="video_extrait format" preload="auto" autoplay loop > 
						<source src="videos/battleship_extrait.mp4" type="video/mp4"> 
						<source src="videos/battleship_extrait.ogv" type="video/ogg"> 
						<source src="videos/battleship_extrait.webm" type="video/webm"> 
						Video not supported
					</video>
					<h1>This week <strong>#anger</strong><br>
						<span class="moviename">Battleship Potemkin</span><br>
						<span class="productor">(by <strong>Sergei Eisenstein</strong>, 1925)<span>
					</h1>
			...
			<main class="thisweek clearfix">
				<section class="synopsis">
					...
					<div class="info-wrapper clearfix">
						<p>The sailors on <strong>Battleship Potemkin</strong> protest against the <strong>government</strong> which feeds them rotten meat. Their <strong>mutiny</strong> turns into a street <strong>riot</strong> which quickly gains momentum.</p>

						<p><i>This movie is considered one of the most important movies in the history of silent films because it is a showcase of Eisenstein’s theories of cinema art</i></p>
						<ul class="clearfix">
				...
				<section class="videoContainer">
						...
						<div class="video-wrapper">
					    	<video id="movies" class="movies" controls preload="auto" poster="img/poster.jpg">
					     	...
					     	<source src="https://ia902607.us.archive.org/33/items/BattleshipPotemkin/Battleship_Potemkin_512kb.mp4"> 
							<source src="http://ia902607.us.archive.org/33/items/BattleshipPotemkin/Battleship_Potemkin.ogv"> 
