...
$data = file_get_contents('http://www.omdbapi.com/?t=The+General&y=&plot=full&r=json');
$data = json_decode($data, true);

//define page title
$title = 'The General - Rewind';
		...
		<div class="container">
			...
			<header>	
					<video class="video_extrait format" preload="auto" autoplay loop > 
						<source src="videos/thegeneral_extrait.mp4" type="video/mp4"> 
						<source src="videos/thegeneral_extrait.ogv" type="video/ogg"> 
						<source src="videos/thegeneral_extrait.webm" type="video/webm"> 
						Video not supported
					</video>
					<h1>This week <strong>#envy</strong><br>
						<span class="moviename">The General</span><br>
						<span class="productor">(by <strong>Joseph M. Schenck</strong>, 1927)<span>
					</h1>
			...
			<main class="thisweek clearfix">
				<section class="synopsis">
					...
					<div class="info-wrapper clearfix">
						<p><strong>Johnnie Gray</strong> tries to enlist with the <strong>Confederate Army</strong> in the beginning of the <strong>American Civil War</strong>, but is rejected because he's a <strong>train engineer</strong> and he is much needed during the war. His girlfriend assumes that he didn’t want to support the <strong>Confederacy</strong> and refuses to ever speak to him again. It so happens that Johnnie’s train, <strong>The General</strong>, is hijacked by the Union and he finally gets a chance to show what he’s really worth!</p>
						<p><i>The General is based on a real incident during the American Civil War when a posse of northern soldiers hijacked a confederate train and a lone southern engineer found himself fighting the lot of them alone. </i></p>					
						<ul class="clearfix">
				...
				<section class="videoContainer">
						...
						<div class="video-wrapper">
					    	<video id="movies" class="movies" controls preload="auto" poster="img/poster.jpg">
					     	...
					     	<source src="https://ia600604.us.archive.org/8/items/TheGeneral1926/The_General_1926_720p_512kb.mp4" type="video/mp4"> 
							<source src="https://ia802709.us.archive.org/33/items/Buster_Keaton_The_General/TheGeneral.ogv" type="video/ogg"> 						
							</video>
							<div class="loading">
