...
$data = file_get_contents('http://www.omdbapi.com/?t=Steamboat+Bill+Jr.&y=&plot=full&r=json');
$data = json_decode($data, true);

//define page title
$title = 'Steamboat Bill Jr. - Rewind';
		...
		<div class="container">
			...
			<header>	
					<video class="video_extrait format" preload="auto" autoplay loop > 
						<source src="videos/steamboat_extrait.mp4" type="video/mp4"> 
						<source src="videos/steamboat_extrait.ogv" type="video/ogg"> 
						<source src="videos/steamboat_extrait.webm" type="video/webm"> 
						Video not supported
					</video>
					<h1>This week <strong>#empathy</strong><br>
						<span class="moviename">Steamboat Bill Jr</span><br>
						<span class="productor">(by <strong>Joseph M. Schenck</strong>, 1928)<span>
					</h1>
			...
			<main class="thisweek clearfix">
				<section class="synopsis">
					...
					<div class="info-wrapper clearfix">
						<p><strong>Steamboat Bill Jr.</strong> is the story of a naive, college-educated dandy</strong> who must <strong>prove himself</strong> to his working-class <strong>father</strong>, a hot-headed riverboat captain, while courting the daughter of his father's rival, who threatens to put <strong>Steamboat Bill Sr.</strong> and his paddle-wheeler <strong>out of business</strong>.</p>
						<p><i>The film contains probably the single most dangerous stunt of the Silent Era and of the history of film-making.  The entire facade of a 2-story house falls on top of Buster Keaton, who survives thanks to standing exactly in the way of an open window.  This was all real without camera tricks and he could have been killed if his position was off by a few inches.</i></p>						
						<ul class="clearfix">
				...
				<section class="videoContainer">
						...
						<div class="video-wrapper">
					    	<video id="movies" class="movies" controls preload="auto" poster="img/poster.jpg">
					     	...
					     	<source src="https://ia802708.us.archive.org/17/items/steamboat_bill_ipod/steamboat_bill.mp4" type="video/mp4"> 
							<source src="https://ia802708.us.archive.org/17/items/steamboat_bill_ipod/steamboat_bill.ogv" type="video/ogg">							
							</video>
							<div class="loading">
