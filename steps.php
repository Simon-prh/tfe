...
$data = file_get_contents('http://www.omdbapi.com/?t=The+39+Steps&y=&plot=full&r=json');
		...
		<div class="container">
			...
			<header>	
					<video class="video_extrait format" preload="auto" autoplay loop > 
						<source src="videos/39steps_extrait.mp4" type="video/mp4"> 
						<source src="videos/39steps_extrait.ogv" type="video/ogg"> 
						<source src="videos/39steps_extrait.webm" type="video/webm"> 
						Video not supported
					</video>
					<h1>This week <strong>#anxiety</strong><br>
						<span class="moviename">The 39 Steps</span><br>
						<span class="productor">(by <strong>Alfred Hitchcock</strong>, 1935)<span>
					</h1>
			...
			<main class="thisweek clearfix">
				<section class="synopsis">
					...
					<div class="info-wrapper clearfix">
						<p>While watching a memory demonstration, <strong>Richard</strong> meets <strong>Annabella, a spy</strong> chased by <strong>assassins</strong>. They go to his apartment where she tells him that she has discovered a group that is planning to <strong>steal vital British military documents</strong>.</p><p> Soon the assassins get to her but before she dies she gives Richard a map with a circled city on it. Can Richard continue her legacy?</p>
				...
				<section class="videoContainer">
						...
						<div class="video-wrapper">
					    	<video id="movies" class="movies" controls preload="auto" poster="img/poster.jpg">
					     	...
					     	<source src="http://ia700408.us.archive.org/4/items/the39steps_ipod/The_39_Steps_512kb.mp4" type="video/mp4"> 
							<source src="http://ia700408.us.archive.org/4/items/the39steps_ipod/The_39_Steps.ogv" type="video/ogg">								
							</video>
							<div class="loading">
