...
$data = file_get_contents('http://www.omdbapi.com/?t=caligari&y=&plot=full&r=json');
		...
		<div class="container">
			...
			<header>	
					<video class="video_extrait format" preload="auto" autoplay loop > 
						<source src="videos/caligari_extrait.mp4" type="video/mp4"> 
						<source src="videos/caligari_extrait.ogv" type="video/ogg"> 
						<source src="videos/caligari_extrait.webm" type="video/webm"> 
						Video not supported
					</video>
					<h1>This week <strong>#fear</strong><br>
						<span class="moviename">The Cabinet of Dr. Caligari</span><br>
						<span class="productor">(by <strong>Robert Wiene</strong>, 1920)<span>
					</h1>
			...
			<main class="thisweek clearfix">
				<section class="synopsis">
					...
					<div class="info-wrapper clearfix">
						<p>A man named Francis relates a story about his best friend Alan and his fiancée Jane. Alan takes him to a fair where they meet Dr. Caligari, who exhibits a somnambulist, Cesare, who can predict the future. When Alan asks how long he'll live, Cesare says he has until dawn.</p>
						<p>The prophecy comes to pass, as Alan is murdered, and Cesare is a prime suspect. Cesare creeps into Jane's bedroom and abducts her, running from the townspeople and finally dying of exhaustion. Meanwhile, the police discover a dummy in Cesare's cabinet, while Caligari flees. Francis tracks Caligari to a mental asylum. He is the director! Or is he? </p>					
						<ul class="clearfix">
				...
				<section class="videoContainer">
						...
						<div class="video-wrapper">
					    	<video id="movies" class="movies" controls preload="auto" poster="img/poster.jpg">
					     	...
					     	<source src="http://ia802701.us.archive.org/8/items/DasKabinettdesDoktorCaligariTheCabinetofDrCaligari/The_Cabinet_of_Dr._Caligari_512kb.mp4" type="video/mp4"> 
							<source src="http://ia802701.us.archive.org/8/items/DasKabinettdesDoktorCaligariTheCabinetofDrCaligari/The_Cabinet_of_Dr._Caligari.ogv" type="video/ogg"> 						
							</video>
							<div class="loading">
