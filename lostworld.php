...
$data = file_get_contents('http://www.omdbapi.com/?t=The+Lost+World&y=1925&plot=full&r=json');
$data = json_decode($data, true);

//define page title
$title = 'The Lost World - Rewind';
		...
		<div class="container">
			...
			<header>	
					<video class="video_extrait format" preload="auto" autoplay loop > 
						<source src="videos/lostworld_extrait.mp4" type="video/mp4"> 
						<source src="videos/lostworld_extrait.ogv" type="video/ogg"> 
						<source src="videos/lostworld_extrait.webm" type="video/webm"> 
						Video not supported
					</video>
					<h1>This week <strong>#surprise</strong><br>
						<span class="moviename">The Lost World</span><br>
						<span class="productor">(by <strong>Harry O. Hoyt</strong>, 1925)<span>
					</h1>
			...
			<main class="thisweek clearfix">
				<section class="synopsis">
					...
					<div class="info-wrapper clearfix">
						<p>See how <strong>Professor Challenger</strong> and his group of brave <strong>explorers</strong> discover that <strong>dinosaurs</strong> still roam the Earth! The crew gets trapped in <strong>the lost world</strong> and goes through a series of frightening events. Soon all hope is lost.</p><p>Could they still escape the plateau?</p>					
						<ul class="clearfix">
				...
				<section class="videoContainer">
						...
						<div class="video-wrapper">
					    	<video id="movies" class="movies" controls preload="auto" poster="img/poster.jpg">
					     	...
					     	<source src="https://ia601701.us.archive.org/30/items/TheLostWorld1925/TheLostWorld1925_512.mp4" type="video/mp4"> 
							<source src="https://ia601701.us.archive.org/30/items/TheLostWorld1925/The%20Lost%20World%201925.ogv" type="video/ogg"> 				
							</video>
							<div class="loading">
