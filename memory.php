				...
				<div class="contour cleafix">
					...
					<?php
							while ($movies = $statement->fetch(PDO::FETCH_ASSOC)){
								...
								// if (($movies['surprise'])) { 
								// echo '<div data-category="'.$movies['emotion'].'" class="movie_resume surprise_movie">
								// 		<div class="movie_data">
								// 			<h1>'.$movies['title'].'</h1>
								// 			<p>'.$movies['author'].'</p>
								// 			<p>'.$movies['emotion'].'</p>
								// 			<p>'.$movies['synopsis'].'</p>
								// 			<a href="'.$movies['link'].'">Voir.</a>
								// 		</div>
								// 		<div class="movie_visu"></div>

								// 	  	</div>';
								// }
								// if (($movies['joy'])) { 
								// echo '<div data-category="'.$movies['emotion'].'" class="movie_resume joy_movie">
								// 		<div class="movie_data">
								// 			<h1>'.$movies['title'].'</h1>
								// 			<p>'.$movies['author'].'</p>
								// 			<p>'.$movies['emotion'].'</p>
