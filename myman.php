...
$data = file_get_contents('http://www.omdbapi.com/?t=My+Man+Godfrey&y=&plot=full&r=json');
$data = json_decode($data, true);

//define page title
$title = 'My Man Godfrey - Rewind';
		...
		<div class="container">
			...
			<header>	
					<video class="video_extrait format" preload="auto" autoplay loop > 
						<source src="videos/myman_extrait.mp4" type="video/mp4"> 
						<source src="videos/myman_extrait.ogv" type="video/ogg"> 
						<source src="videos/myman_extrait.webm" type="video/webm"> 
						Video not supported
					</video>
					<h1>This week <strong>#passion</strong><br>
						<span class="moviename">My Man Godfrey</span><br>
						<span class="productor">(by <strong>Gregory La Cava</strong>, 1936)<span>
					</h1>
			...
			<main class="thisweek clearfix">
				<section class="synopsis">
					...
					<div class="info-wrapper clearfix">
						<p>In the depths of <strong>the Depression</strong>, a party game brings dizzy socialite <strong>Irene Bullock</strong> to the city dump where she meets <strong>Godfrey</strong>, a derelict, and ends up hiring him as <strong>family butler</strong>. He finds the Bullocks to be the epitome of idle rich, and nutty as the proverbial fruitcake. </p><p>Soon, the dramatizing Irene is <strong>in love</strong> with her 'protege'...who feels strongly that a <strong>romance</strong> between servant and employer is out of place, regardless of that servant's <strong>mysterious past</strong>.</p>					
						<ul class="clearfix">
				...
				<section class="videoContainer">
						...
						<div class="video-wrapper">
					    	<video id="movies" class="movies" controls preload="auto" poster="img/poster.jpg">
					     	...
					     	<source src="https://ia902606.us.archive.org/24/items/my_man_godfrey/my_man_godfrey_512kb.mp4" type="video/mp4"> 
							<source src="https://ia902606.us.archive.org/24/items/my_man_godfrey/my_man_godfrey.ogv" type="video/ogg"> 					
							</video>
							<div class="loading">
